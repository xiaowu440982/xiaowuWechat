...
// gateway网关地址
define('gateway_address', '0.0.0.0:7272');

// gateway网关名称
define('gateway_name', 'ChatGatewayXiaowu');
...
// gateway网关起始端口
define('gateway_start_port', '2300');

// gateway注册地址
define('gateway_register_address', '127.0.0.1:1237');
...
// business_worker进程名称
define('business_worker_name', 'ChatBusinessWorkerXiaowu');
...
define('business_event_handler', 'app\chat\controller\Events');
