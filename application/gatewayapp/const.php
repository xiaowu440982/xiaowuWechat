...
// 注册协议
define('register_protocol', '0.0.0.0:1236');

// 注册地址
define('register_address', '127.0.0.1:1236');

// 网关地址
define('gateway_address', '0.0.0.0:8283');
...
// 网关名称
define('gateway_name', 'Gateway001');

// worker进程名称
define('worker_name', 'BusinessWorkerXiaowu');
...
define('business_event_handler', 'app\gatewayapp\controller\gwEvents');
