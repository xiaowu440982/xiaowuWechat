...
// 注册地址
define('register_address', '127.0.0.1:1238');

// 网关地址
define('gateway_address', '0.0.0.0:8285');
...
// worker进程名称
define('worker_name', 'ChatRoomXiaowu');
...
define('business_event_handler', 'app\chatroom\controller\Events');
